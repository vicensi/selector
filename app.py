...
with tab1:
    ...
    st.subheader("📈 Volume Financeiro por Status de Fraude")
    chart = timechart_amount_by_fraud(df_filtered)
...
with tab2:
    ...
    with col_graph01:
        ...
        chart = top_risk_transaction_count(df_filtered)
        st.altair_chart(chart)    
